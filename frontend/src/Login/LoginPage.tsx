        ...
        <form onSubmit={handleSubmit}>
          <div className="input-group">
            <input 
              ...
              required
              style={{ padding: '0.8rem', width: '100%', borderRadius: '4px', background: 'rgba(0,0,0,0.3)', border: '1px solid var(--border-color)', color: 'white', marginBottom: '1rem' }}
            />
          </div>
          <div className="input-group">
            <input 
              ...
              required
              style={{ padding: '0.8rem', width: '100%', borderRadius: '4px', background: 'rgba(0,0,0,0.3)', border: '1px solid var(--border-color)', color: 'white', marginBottom: '1.5rem' }}
            />
          </div>
